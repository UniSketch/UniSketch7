...
export class Text extends PositionedSketchElement {
    ...
    public intersectsText(start: any, end: any): boolean {
        return this.isWithinRadius(start, 0);
    }
    ...
    /**
     * Update the position of this text.
     */
